  ...
  return (
    <article className={styles.container}>
      ...
      <div className={styles.tilesContainer}>
        <RadioTile checked={selected === "free"} value="free" className={styles.tile} onClick={handleOnClick("free")}>
        ...
        <RadioTile checked={selected === "1"} value="1" className={styles.tile} onClick={handleOnClick("1")}>
        ...
        <RadioTile checked={selected === "2"} value="2" className={styles.tile} onClick={handleOnClick("2")}>
        ...
        <RadioTile checked={selected === "3"} className={styles.tile} value="3" onClick={handleOnClick("3")}>
